...
// import { getProducts } from '../products/productSlice'; // <-- REMOVE THIS (Not needed here)
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(createOrder.fulfilled, (state, action) => {
        ...
        // action.asyncDispatch(getProducts()); // <-- DELETED THIS LINE
        // The Dashboard component handles the refetching via useEffect
      })
