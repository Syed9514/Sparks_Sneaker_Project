...
export default function Women() {
  ...
  if (categoryProducts.length === 0 && categoryStatus === 'succeeded') {
    return <div>No products found in the Women's category.</div>;
  }

  // Pass the ID as a prop to ShowcasePage
  return <ShowcasePage products={categoryProducts} selectedProductId={selectedProductId} title="Women" />;
}